...
from the test suite ("simulated db error", "connection refused",
"sql_scan_blocked", ...) were posted to the real team Slack channel on every
check run. These fixtures make the test suite integration-silent.
"""
import os
import pytest
