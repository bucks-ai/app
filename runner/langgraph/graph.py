...
def _checkpoint_wip_on_stop(state: RunnerState) -> RunnerState:
    ...
    """
    # Dry-run promises no git side effects at all (see main.py cmd_dry_run), and
    # a synthetic task has no work worth saving.
    if not cfg.wip_checkpoint_enabled or cfg.runner_dry_run:
        return state
