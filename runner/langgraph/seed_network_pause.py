...
TASKS = [
    {
        ...
        "description": (
            ...
            "(c) WATCHDOG WIRING + PATIENCE. `network_unavailable` must NOT be added to "
            "HARD_GATE_REASONS (a human is not required — the driver just needs to arrive). It "
            "falls through to the default 30s restart, which is correct. What must be added is a "
            "PATIENCE CEILING: track cumulative offline time across consecutive "
            ...
            "NETWORK_PROBE_TIMEOUT_S, NETWORK_MAX_PATIENCE_MINUTES (default 90). Disabled restores "
            ...
            "`network_unavailable` is not a hard gate and restarts at the default delay; cumulative "
