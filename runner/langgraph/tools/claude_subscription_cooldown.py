...
"Claude usage limit reached. Your limit will reset at …".  Rather than
...
def _parse_wait_seconds(
    ...
    """Parse cooldown duration from the response text; return ``default_wait_s`` if not found."""
...
def evaluate_subscription_cooldown(
    ...
    *,
    ...
    wait_s = _parse_wait_seconds(output, error, default_wait_s)
