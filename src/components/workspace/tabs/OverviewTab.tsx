            ...
            <div className="flex shrink-0 flex-col items-stretch gap-2 sm:items-end">
              {onBlueprintOpen ? (
                <button
                  ...
                  className="self-start rounded-md border border-border bg-background px-3 py-2 font-mono text-[11px] uppercase tracking-widest text-foreground-secondary transition-colors hover:border-accent/45 hover:text-accent sm:self-end"
                >
                  Blueprint
                </button>
              ) : null}
