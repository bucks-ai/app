  ...
  return (
    <div className="rounded-md border border-[#22C55E]/25 bg-[#22C55E]/10 p-4">
      ...
      <a
        ...
        target="_blank"
        rel="noreferrer"
        className="mt-4 inline-flex max-w-full break-all rounded-md border border-[#22C55E]/30 bg-[#080808] px-3 py-2 text-sm font-semibold text-[#86EFAC] transition-colors hover:border-[#22C55E]/60 hover:text-[#BBF7D0]"
      >
        {result.repoUrl}
      </a>
      {warning ? (
