...
export function StatusChip({
  ...
  return (
    <span
      className={`inline-flex flex-shrink-0 items-center gap-1.5 rounded-full bg-muted px-2.5 py-1 font-mono text-[11px] font-medium uppercase tracking-[0.18em] text-foreground-secondary ${className}`}
    >
      <span
        aria-hidden
